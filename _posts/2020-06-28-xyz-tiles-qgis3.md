---
title: Basemap In QGIS3
date: 2020-06-29 01:00:00 +0545
categories: [GIS, QGIS]
tags: [XYZ Tile, Web Basemap]
toc: true
---


Basemaps are brilliantly helpful and anyone coming from ArcGIS software are a lot familiar with beautiful basemaps.
Basemaps are often presented through different webservices: TMS, WMS, WMTS, ESRI ArcGIS Services or simply as XYZ tiles (see [differences](https://gis.stackexchange.com/a/242978) ).
This goal can be achieved in QGIS either through plugin like QuickMapServices or using inbuilt feature XYX Tile 
## Process I -  By Adding Plugin Support
...
## Process - II By Adding new connection in XYZ Tiles
...
Under Authentication, if there are any authentication information required enter them.

If you prefer to use script to add multiple basemaps, Copy and Paste the following script in QGIS Python Console to get most of the basemaps from different providers.
This script by Klas Karlsson automates adding XYZ Tiles in QGIS3.
